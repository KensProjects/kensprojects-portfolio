...
export default function ProjectComponent({
  ...
  return (
    <div className="h-fit sm:w-3/4  w-full border border-black text-center grid grid-cols-1 md:grid-cols-3 justify-between items-center text-black p-8 bg-gray-100">
      ...
      <div className="flex flex-col justify-center items-center text-center py-4">
        ...
        <ul className="list-inside grid grid-cols-1 justify-center items-center list-none h-fit w-full text-center gap-1">
